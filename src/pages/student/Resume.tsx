...
import { analyzeResume, getGeminiApiKey, setGeminiApiKey } from '../../lib/gemini';
    ...
    <div className="space-y-8 antialiased">
      ...
      {showKeyModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 antialiased">
          <div className="bg-surface border border-surface-border rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              AVUNK uses Google Gemini AI (Gemini 3.6 Flash / 3.7 Flash) with built-in heuristic intelligence fallback. You can use the configured system key or paste your custom key from Google AI Studio.
            </p>
            ...
            <div>
              ...
              <input
                ...
                placeholder="AIzaSy..."
                className="w-full px-3 py-2 bg-background border border-surface-border rounded-lg text-xs text-white focus:outline-none focus:border-slate-400 font-mono"
              />
              <span className="text-[10px] text-slate-500 mt-1 block">
                Stored securely in your browser session and environment.
              </span>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-surface-border">
              <Button
                ...
                onClick={() => {
                  setGeminiApiKey('');
                  setCustomKey(getGeminiApiKey());
                  setKeyNotice('Reset to default system key.');
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setKeyNotice('✓ Key saved successfully!');
                  setTimeout(() => {
                    setKeyNotice('');
